    ...
    <div className={classes.root}>
      ...
      >
        <Toolbar variant="dense" className={classes.toolbar}>
          ...
          >
            {i18n.t("mainDrawer.appBar.message.hi")} {user.name}, {i18n.t("mainDrawer.appBar.message.text")} {system.name || "Gestiondechat"}
          </Typography>
          ...
          <div>
            ...
            >
              ...
              <span className={classes.systemCss}>
                <Link color="inherit" href={system.url || "https://github.com/aventuradigital/Gestiondechat"}>
                  v{systemVersion}
                </Link>
              </span>
            </Menu>
